...
function giveResultsOfWord(e) {
  ...
  getWordMeaning(wordTyped);
}


function getWordMeaning(wordTyped) {
  ...
  xhr.onload = function () {
    ...
    if (!parsedData.length) {
      ...
      noResultFound.innerHTML = `&rarr; <strong>No Result Found</strong> , Please Type Something Meaningful ... `;
      return;
    }
